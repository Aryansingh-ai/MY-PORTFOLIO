    ...
    <section id="about" className="min-h-screen flex items-center justify-center py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass p-8 rounded-2xl neon-glow">
              ...
              >
                <PenTool className="text-[#00FFCB] w-8 h-8" />
              </motion.div>
              ...
              {/* Sticky Note Effect */}
              <motion.div
                className="bg-[#FF4C60] p-4 rounded-lg transform rotate-2 shadow-lg"
            ...
            {[
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-gradient-to-br from-[#00FFCB] to-[#FF4C60] rounded-full">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="glass p-6 rounded-2xl inline-block neon-glow-pink">
